 ...
 *
 */
package net.mcreator.donkeydelight;
...
@Mod("donkey_delight")
public class DonkeyDelightMod {
	public static final Logger LOGGER = LogManager.getLogger(DonkeyDelightMod.class);
	public static final String MODID = "donkey_delight";

	public DonkeyDelightMod() {
